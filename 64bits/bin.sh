...
echo "Installing $SUBLIME_VERSION 64bits"
wget http://c758482.r82.cf2.rackcdn.com/$SUBLIME_VERSION_amd64.deb
dpkg -i $SUBLIME_VERSION_amd64.deb
rm -f $SUBLIME_VERSION_amd64.deb
